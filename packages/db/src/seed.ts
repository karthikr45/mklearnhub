          ...
          topics: [
            {
              ...
              questions: [
                ...
                {
                  text: 'The kinetic energy of a body is $K = \\frac{1}{2} m v^2$. If mass is $2\\,kg$ and $v = 3\\,m/s$, then $K$ is:',
                  options: opt('$6\\,J$', '$9\\,J$', '$12\\,J$', '$18\\,J$'),
                  correct: 'b',
                  explanation: 'K = ½·2·3² = $\\frac{1}{2}\\times 2\\times 9 = 9\\,J$.',
                  difficulty: 'MEDIUM',
                  examTrack: 'JEE_MAIN',
                },
              ],
