...
export default function CourseEnrollmentEmail({
  ...
  return (
    <BrandLayout preview={`You're enrolled in ${courseTitle}`}>
      <Heading style={styles.heading}>You&apos;re enrolled!</Heading>
      <Text style={styles.text}>
        Hi {name}, you&apos;ve successfully enrolled in{' '}
        <strong>{courseTitle}</strong>. Your first lesson is ready whenever you
        are.
      </Text>
      ...
      <Text style={styles.text}>
        Set aside a little time each day and you&apos;ll be finished before you
        know it.
      </Text>
    </BrandLayout>
  );
